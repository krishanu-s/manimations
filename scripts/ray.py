...
class Ray:
	...
	start: Point
	direction: Vector
	def __init__(self, start: Point, direction: Vector):
		self.start = start
	...
	def point_at_dist(self, distance: float) -> Point:
...
class Hyperplane:
	...
	def reflect(self, vector: Vector) -> Vector:
